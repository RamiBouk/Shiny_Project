...
new_data <- data.frame(
  ...
  `ROC Default` = c(0.60, 0.74, 0.57, 0.95, 0.63, 0.74, 0.74, 0.89, 0.64, 0.68, 0.68, 0.80),
...
- **Best Performing Model:** The **SVM_RBF** model consistently shows superior performance across all data balancing techniques, especially with **Oversampling** and **Undersampling** approaches.
